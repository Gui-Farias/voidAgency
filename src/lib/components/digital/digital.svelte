...
<section class="md:flex md:justify-between lg:justify-evenly animate-fadeIn">
  ...
  <div class="text md:w-2/5 mt-40 md:pb-32">
    ...
    <p class="digiText transition-all opacity-0 pt-[12vh] pb-[15vh]" data-index="1" >Aqui acreditamos que cada projeto começa ouvindo. Primeiro, entendemos suas dores e metas, depois traçamos estratégias personalizadas.</p>
    <p class="digiText transition-all opacity-0 pt-[10vh] pb-[15vh]" data-index="2" >Apresentamos as soluções personalizadas. Se necessário, ajustamos tudo em parceria com você para garantir que o resultado final esteja alinhado com o esperado!</p>
    <p class="digiText transition-all opacity-0 pt-[12vh] pb-[22vh]" data-index="3" >A Void segue com o desenvolvimento completo, aplicando práticas de performance e acessibilidade para garantir uma experiência digital de alto nível.</p>
